...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.logo_label.setGeometry(QRect(500, 10, 261, 71))
        self.searchButton = QPushButton(self.centralwidget)
        self.searchButton.setObjectName(u"searchButton")
        self.searchButton.setGeometry(QRect(380, 90, 471, 201))
        font = QFont()
        ...
        self.addNewPatientButton.setGeometry(QRect(380, 300, 471, 201))
        self.addNewPatientButton.setFont(font)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QMenuBar(MainWindow)
        self.menubar.setObjectName(u"menubar")
        self.menubar.setGeometry(QRect(0, 0, 1240, 27))
